...
projects[votingapi][download][tag] = 7.x-2.4
...
projects[jquery_plugin][download][url] = http://git.drupal.org/project/jquery_plugin.git
projects[jquery_plugin][download][tag] = 7.x-1.0
