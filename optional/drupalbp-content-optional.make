...
projects[relation][download][tag] = 7.x-1.0-beta3
...
projects[content_access][download][tag] = 7.x-1.2-beta1
...
projects[extlink][download][url] = http://git.drupal.org/project/extlink.git
projects[extlink][download][tag] = 7.x-1.12
...
projects[fivestar][download][tag] = 7.x-2.0-alpha1
...
;projects[addtoany][download][url] = http://git.drupal.org/project/addtoany.git
;projects[addtoany][download][tag] = 7.x-3.1
;projects[addtoany][subdir] = contrib

projects[author_pane][version] = 2.0-alpha1
projects[author_pane][download][type] = git
